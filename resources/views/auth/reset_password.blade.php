<x-layouts.main-layout pageTitle="Resetar senha">
      ...
      <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-6">
                    ...
                    <form action="{{ route('reset_password_update', ['token' => $token]) }}" method="post">

                        @csrf

                        {{-- campo que mantem o token --}}
                        ...
                        <div class="row mt-4">
                             <div class="col text-end">
                                <a href="{{ route('login') }}"> Não quero mudar a senha </a>
                            </div>
                            <div class="col text-end">
